...
class Container(tk.Frame):
    ...
    def widgets(self):
        ...
        btnventas.config(image=imagen_tk, compound=LEFT, padx=10)
        ...
        btninventario = Button(frame1, bg="#c62e26", fg="white",font="sans 15 bold", text="IR A INVENTARIO", command=self.inventario)
        btninventario.config(image=imagen_tk, compound=LEFT, padx=5)
        btninventario.image = imagen_tk
        btninventario.place(x=500, y=130, width=240, height=60)

        ruta=self.rutas(r"imagenes/tienda.png")
        ...
        copyright_label = tk.Label(frame1, text="2025 JUAN MARCOS COCA MIRANDA SIS2420", font="sans 12 bold",bg="#C6D9E3", fg="gray")
